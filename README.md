...
### MiniMax-M3-MXFP8 壓力測試結果 (H200 × 4, TP=4)
...
### 2. MiniMax-M3-MXFP8 (TP=4) 啟動流程

| 階段 | 說明 | 預估時間 |
|------|------|---------|
| 1. 模型載入 | 讀取 MXFP8 safetensors 權重分片 | ~2~3 min (視訊記憶體開銷減半) |
| 2. NCCL/分散式通訊 | 4 個 TP rank 建立通訊與初始化 | ~10s |
